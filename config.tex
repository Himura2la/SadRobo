...
\usepackage{rotating} %Для поворота текста
...
\usepackage{tabu} % Таблички для вертикальных надписей (верстаем таблицами, да)

% Кошерное многоточие c http://kostyrka.ru/blog/archives/883 
% Usage: Я хочу летать\ldotst{} Кто же этого не хочет\ldotsq{} Рассекать воздух "--- это так прекрасно\ldotse{}
