...
\newdialog{036}{Митинг}{Made in Python}
\newdialog{040}{Мой здравый смысл}{Made in Python}
\newdialog{061}{Утренняя газета}{Made in Python}
\newdialog{071}{Лао Цзы}{Made in Python}
\newdialog{072}{Время}{Made in Python}
\newdialog{074}{Даос-какаос}{Made in Python}
\newdialog{088}{Мотивация}{Made in Python}
\newdialog{089}{Политика}{Made in Python}
\newdialog{090}{Маркетинг}{Made in Python}
\newdialog{095}{Боян}{Made in Python}
\newdialog{108}{Калечные девы}{Made in Python}
\newdialog{109}{Лекция}{Made in Python}
\newdialog{134}{Шайа Лабаф}{Made in Python}
\newdialog{137}{Шон Бин}{Made in Python}
\newdialog{140}{Аниме}{Made in Python}
\newdialog{148}{Председатель земного шара}{Made in Python}
