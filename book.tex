...
\newdialog{Викинги}{Борода лучше своего отсутствия}{1}
\newdialog{Создатель}{Все мы что-то создаём}{2}
\newdialog{Паук}{Тащемта, например}{3}
\newdialog{Ницше}{Сверхчеловек не нашего времени}{4}
