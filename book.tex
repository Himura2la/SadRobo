...
\newcommand{\newdialog}[3]{
	\chapter{Робот, которому грустно, и #1}
		...
		\begin{figure}[p!]
			\centering
			\includegraphics[height = 170mm, width = \linewidth, keepaspectratio]{#1}    %170 для того, чтобы вместилась надпись
			\center{#2}
			%\label{pic:#1}
		\end{figure}
	\setcounter{dianum}{#3}
...
\newdialog{Викинги}{Борода лучше своего отсутствия}{002}
\newdialog{Создатель}{Все мы что-то создаём}{004}
\newdialog{Паук}{Тащемта, например}{014}
\newdialog{Ницше}{Сверхчеловек не нашего времени}{018}
